<?php
namespace Entrepreneur\Http\Middleware;

use Closure;
use Illuminate\Contracts\Foundation\Application;
use Entrepreneur\Services\SignatureService;
use Entrepreneur\Exceptions\SignatureException;
...
class CheckRequestSignature
{
    ...
    /**
     * @var \Entrepreneur\Services\SignatureService
     */
    private $service;
